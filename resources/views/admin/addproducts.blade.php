          ...
          <div class="card-body">
            <form action="" method="POST">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control" id="subcategory_name" name="subcategory_name" placeholder="11" />
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control" id="subcategory_name" name="subcategory_name" placeholder="11111" />
                </div>
              </div>
